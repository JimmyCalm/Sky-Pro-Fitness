...
// Инициализируем один раз при первом рендере
const [localProgressData, setLocalProgressData] = useState<number[]>(
  ...
  const success = await updateProgress(localProgressData);
      ...
      <main className="py-10 px-4 max-w-5xl mx-auto">
        ...
        {workout.video && (
          <div className="aspect-video mb-10 rounded-xl overflow-hidden shadow-lg bg-black">
            <ReactPlayer
              ...
              playing={false}
              pip
              light={true} // опционально — превью вместо чёрного экрана
            />
          </div>
        )}
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-6">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <span className="text-gray-700">Выполнено полностью</span>
                  </label>
        ...
        <div className="mt-12 text-center">
          <button
            ...
            disabled={isCompleted || localProgressData.every((v) => v === 0)}
            className={cn(
          ...
          >
            {isCompleted ? 'Тренировка уже завершена' : 'Завершить тренировку'}
          </button>
