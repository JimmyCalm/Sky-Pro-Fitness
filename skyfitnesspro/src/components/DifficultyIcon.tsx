...
const DifficultyIcon: FC<DifficultyIconProps> = ({
  ...
  const inactiveFromLeft = 5 - filledFromLeft;
    ...
    >
      <g clipPath="url(#clip0_17_2324)">
        ...
        <path
          ...
          fill={inactiveFromLeft < 1 ? color : '#D9D9D9'}
        />
        ...
        <path
          ...
          fill={inactiveFromLeft < 2 ? color : '#D9D9D9'}
        />
        ...
        <path
          ...
          fill={inactiveFromLeft < 3 ? color : '#D9D9D9'}
        />
        ...
        <path
          ...
          fill={inactiveFromLeft < 4 ? color : '#D9D9D9'}
        />
        ...
        <path
          ...
          fill={inactiveFromLeft < 5 ? color : '#D9D9D9'}
        />
      </g>
      <defs>
